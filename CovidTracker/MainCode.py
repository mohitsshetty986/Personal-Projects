...
sortperworsthit_country_df=country_df.sort_values('confirmed',ascending=False)
#print(sortperworsthit_country_df)
...
for i in range(len(confirmed_df)):
    ...
    fill=True, fill_color='grey',radius=(int(np.log(confirmed_df.iloc[i,-1]+1.00001))+0.2)*50000,
